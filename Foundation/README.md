# ShadowGuard Foundation Library
...
| Kód | Role |
|-----|------|
| **CZ** | Primární jazyk vzniku myšlenek |
...
| ID | Název | Stav |
|----|--------|------|
| SGF-001 | ShadowGuard Constitution | připravuje se |
| SGF-002 | The ShadowGuard Way | připravuje se |
| SGF-003 | Founding Statement | **v1.0 Founding Edition** |
