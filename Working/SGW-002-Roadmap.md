...
|------|--------|-------------------|
| **Foundations** | Budování základů — filozofie, protokoly, paměť | **probíhá** (většina SGF hotová; před release ještě revize) |
| **Direction** | Směr a architektura (Architecture Truth, top 10) | další |
| **Craft** | Poctivá stavba Shadvertu (security → hybrid → UX) | potom |
| **Trust** | Testování s prvními lidmi (rodina, známí) | potom |
...
1. Security pass (klíče, Helmet, rate-limit, CI)  
2. Hybridní verdikt + prompty  
3. Senior-first výchozí cesta  
4. Testy + QA  
